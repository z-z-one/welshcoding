...
//    }
    ...
    public String list2(Model model, HttpSession session) throws Exception {
...
//        String[] result = set.toArray(new String[set.size()]);
    ...
    public String goPost(@PathVariable Long postId, Model model, HttpSession session) throws Exception {
    ...
    @PostMapping("search")
    @ResponseBody
    public String search(HttpSession session, @RequestParam("inputSearch") String inputSearch) throws Exception {
        Member member = (Member) session.getAttribute("member");
    ...
    public String delPost(@PathVariable Long boardId, Model model, HttpSession session) throws Exception {
        Member member = (Member) session.getAttribute("member");
    ...
    public String changePost(@PathVariable Long boardId, Model model, HttpSession session) throws Exception {
        Member member = (Member) session.getAttribute("member");
